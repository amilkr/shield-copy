 ...
 * Private Functions
 */
static void log_write_in_level(t_log* logger, t_log_level level,  char** message_template, va_list arguments);
 ...
 *
 */
void log_trace(t_log* logger, char** message_template, ...) {
	va_list arguments;
 ...
 *
 */
void log_debug(t_log* logger, char** message_template, ...) {
	va_list arguments;
	va_start(arguments, message_template);
 ...
 *
 */
void log_info(t_log* logger, char** message_template, ...) {
	va_list arguments;
	va_start(arguments, message_template);
 ...
 *
 */
void log_warning(t_log* logger,  char** message_template, ...) {
	va_list arguments;
	va_start(arguments, message_template);
 ...
 *
 */
void log_error(t_log* logger,  char** message_template, ...) {
	va_list arguments;
	va_start(arguments, message_template);
